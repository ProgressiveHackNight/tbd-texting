...
REMINDER_MESSAGE_KEY = 'REMINDER_MESSAGE'

class Command(BaseCommand):
    help = 'Sends the reminder on the day of based on the `reminder_date`'
    ...
    def handle(self, *args, **options):
        ...
        message = Message.objects.get(keyword=REMINDER_MESSAGE);
